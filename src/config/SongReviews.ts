const songReviews = {
    ...
    '2NFWA9nqzDh4glNiNp1Stc': { 'name': 'Pressure - Alesso Remix', 'review': 'An OG techno classic.' },
    '46lFttIf5hnUZMGvjK0Wxo': { 'name': 'Runaway (U & I)', 'review': 'It\'s topical (RUN away).' },
    ...
    '0LIU3eOAwXCZlWOiHuItkj': { 'name': 'Help Our Souls (Urban Contact Radio Edit)', 'review': 'Smooth smooth, techno jam.' },
    ...
    '4XLm8FNvaTlmTAZmSrrV82': { 'name': 'Shots - Broiler Remix', 'review': 'Insirpation, song form.' },
    ...
    '22qUyTlEvJf6DAlyQjMADe': { 'name': 'Leaving You', 'review': 'Sad lyrics, great beat.' },
    ...
    '5kgqTe1BM720OjU78TGYDw': { 'name': 'Tell Me You Love Me', 'review': 'Honestly just threw all of Galantis\'s new songs on this playlist.' },
